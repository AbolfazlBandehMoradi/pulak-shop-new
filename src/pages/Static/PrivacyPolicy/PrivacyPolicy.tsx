...
const PrivacyPolicy = () => {
    ...
    const defaultPolicy: PrivacyPolicyTranslation = {
        title: "",
        description: "",
        rules: [],
        contactTitle: "",
    ...
    const policyData =
        (t("static.privacyPolicy", { returnObjects: true }) as PrivacyPolicyTranslation) ||
        defaultPolicy;
        ...
        <main dir={dir} className="sm:container mt-8 lg:mt-16 mx-auto px-4">
            ...
            >
                <figure className="w-full lg:w-16/48 xl:w-12/48 2xl:w-12/48">
                    <img
                        src={ShopImage}
                        alt={policyData.title || t("static.privacyPolicy.imageAlt")}
                ...
                <div className="w-full lg:w-31/48 xl:w-35/48 2xl:w-35/48 flex flex-col justify-between mt-4 lg:mt-0">
                    ...
                    <ul
                        ...
                        aria-label={t("static.privacyPolicy.rulesList")}
                    >
