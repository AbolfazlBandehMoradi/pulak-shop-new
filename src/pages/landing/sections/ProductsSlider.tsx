    ...
    <section className="product-slider relative sm:container mx-auto mt-8 lg:mt-16 px-4 ">
      ...
      <div className="w-full  bg-color-for-layer-on-body rounded-4xl  overflow-hidden mt-4">
        <div className="flex flex-wrap">
          <div className="relative w-full lg:w-16/48 xl:w-10/48 bg-first p-8 flex flex-col justify-between">
            ...
            <div>
              ...
              <p className="text-sm/6 text-white mb-2 lg:mb-0 mt-2">
          ...
          <div className="w-full xl:w-38/48 lg:w-32/48 p-4 mx-auto relative">
            <Swiper
              slidesPerView={1}
              spaceBetween={24}
              modules={[Navigation]}
            ...
            >
              {showCase?.items?.map((item) => (
                <SwiperSlide key={item.id}>
                  ...
                  >
                    <div className="h-95 relative flex flex-col justify-between  ">
