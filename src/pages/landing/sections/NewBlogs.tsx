...
const NewBlogs = ({blogs}: Props) => {
 ...
 <div className="sm:container mt-8 lg:mt-16 mx-auto px-4 relative">
      <div className="flex items-center justify-between ">
        <div className="flex items-center flex-wrap justify-between w-full ">
          <div className="flex items-center gap-3 w-full lg:w-6/12">
            ...
            <div className="">
              <h2 className="text-2xl font-s-sbold first-text-color">
                آخرین های
              ...
              <p className="text-base first-text-color-for-paragraph text-nowrap mt-2">
      ...
      <div className="flex flex-wrap justify-between mt-5">
        ...
        <div className="lg:w-17/48 xl:w-26/48 w-full   flex flex-col justify-between">
          {blogs?.length! > 0 &&
            blogs
              ?.slice(0, blogs.length - 1)
              .map((blog) => <Link
      to={`/blogs/${blog?.title}`}
      className="w-full bg-color-for-layer-on-body rounded-2xl lg:first:mt-0 mt-3  p-4 flex justify-between"
    >
      <div className="w-15/48  ">
        <img
          className="w-full rounded-xl h-full object-cover object-right"
          src={blog?.image}
          alt="img"
        />
      </div>
