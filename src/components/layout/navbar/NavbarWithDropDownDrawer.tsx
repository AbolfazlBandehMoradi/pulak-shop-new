...
export const NavbarWithDropDownDrawer: React.FC = () => {
            ...
            <div className="flex w-full items-center justify-end gap-3 lg:w-auto">
              ...
              {!isAuthenticated ? (
                <Link
                  ...
                  className={` font-s-medium first-text-color flex h-12
              ...
              <Link
                className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-first"
