...
export const NavbarWithDrawer: React.FC = () => {
  ...
  return (
    <nav className="navbar-shell my-8">
      {!isMobile && (
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex w-full items-center gap-3 lg:w-8/12">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-8/96  hover:bg-first hover:text-white flex items-center border-r border-gray-200 dark:border-gray-600  justify-center group"
            ...
            <div className="flex w-full items-center justify-end gap-3 lg:w-auto">
              ...
              {!isAuthenticated ? (
                <Link
                  ...
                  className={`font-s-sbold  flex h-12
                   items-center justify-center border border-first hover:bg-first-100 dark:hover:bg-first-900 text-first gap-2 rounded-xl bg-color-for-layer-on-body px-4`}
                >
              ...
              <Link
                className="relative flex py-2 px-4 gap-2 h-12 items-center justify-center rounded-xl bg-first"
                to={localizedPath('/cart')}
                aria-label={navLabels.cart}
              >
                <span className=" h-5 relative w-5 rounded-full text-white   text-center text-xs leading-6">
                  <span className="relative z-99">{cartCount}</span>
                  <span className="bg-first-500 w-full h-full rounded-md absolute inset-0"></span>
                </span>
                <ShoppingBag strokeWidth={1.5} className=" w-5 h-5 text-white" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto bg-color-for-layer-on-body mt-8 p-4">
        {!isMobile ? (
          <div dir={dir} className="container mx-auto  flex items-center justify-between ">
            ...
            <span className="flex flex-col justify-center  ">
              <span className="flex justify-between">
                <span className="text-xs first-text-color-for-paragraph-low">شماره تماس</span>
                <Phone strokeWidth={1.5} className=" w-4 h-4 text-first" />
              </span>
              <span className="text-sm first-text-color-for-paragraph mt-2">09392056442</span>
            </span>
          </div>
        ) : (
          <div className="mx-auto ">
            <div className="space-y-2">
              <div className="flex items-center justify-between rounded-2xl">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {!isAuthenticated ? (
                    <Link
                      to={localizedPath('/auth')}
                      className="rounded-lg bg-first px-6 h-10 pb-1 flex items-center  font-s-sbold text-white"
                    >
              ...
              <form
                className="flex w-full h-14 overflow-hidden border mt-4 border-gray-300 dark:border-gray-500 rounded-xl "
                name="mobile-search"
                onSubmit={handleSearchSubmit}
              >
                <input
                ...
                <button
                  type="submit"
                  className="w-20/96  hover:bg-first hover:text-white flex items-center border-r border-gray-200 dark:border-gray-600  justify-center group"
                  aria-label={searchPlaceholder}
                >
                  <svg
                    className="text-gray-500 group-hover:text-white"
