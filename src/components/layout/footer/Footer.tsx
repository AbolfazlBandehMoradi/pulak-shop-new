      ...
      <div className={`footer-wrapper relative mx-auto mt-8 px-4 ${isProductDetailPage ? ' pt-4 pb-20 ' : ' pt-4 pb-8 ' } sm:container lg:pb-12 lg:pt-4`} >
            ...
            <div key={feature.key} className="footer-feature-item">
              ...
              <div className="footer-feature-content">
                <h5 className="font-s-sbold text-base first-text-color">
                  {t(`footer.features.${feature.key}.title`)}
                </h5>
                <p className="text-sm leading-7 first-text-color-for-paragraph">
                  {t(`footer.features.${feature.key}.description`)}
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="footer-content-grid">
          <div className="footer-about-column">
            <h5 className="font-s-sbold text-base first-text-color">{t('footer.about.title')}</h5>
            <ul className="mt-2">
              <li className="text-sm leading-7 first-text-color-for-paragraph">
          ...
          <div className="footer-links-column">
            <h5 className="font-s-sbold text-base first-text-color">{t('footer.support.title')}</h5>
            <ul className="mt-2">
              <li className="footer-link-row group">
                <span className="footer-link-dot"></span>
                <Link className="footer-link-anchor" to={localizedPath('/about-us')}>
                  {t('footer.support.about')}
                </Link>
              </li>
              <li className="footer-link-row group">
                <span className="footer-link-dot"></span>
                <Link className="footer-link-anchor" to={localizedPath('/contact-us')}>
              ...
              <li className="footer-link-row group">
                ...
                >
                  {t('footer.support.instagram')}
                </Link>
              </li>
              <li className="footer-link-row group">
                <span className="footer-link-dot"></span>
                <a href="tel:09392056442" className="footer-link-anchor">
          ...
          <div className="footer-links-column">
            <h5 className="font-s-sbold text-base first-text-color">{t('footer.links.title')}</h5>
            <ul className="mt-2">
              <li className="footer-link-row group">
                <span className="footer-link-dot"></span>
                <Link className="footer-link-anchor" to={localizedPath('/faq')}>
                  {t('footer.links.faq')}
                </Link>
              </li>
              <li className="footer-link-row group">
              ...
              <li className="footer-link-row group">
                <span className="footer-link-dot"></span>
                <Link className="footer-link-anchor" to={localizedPath('/return-policy')}>
          ...
          <div className="footer-seal-column">
            <a
              ...
              target="_blank"
              href="https://trustseal.enamad.ir/?id=451010&Code=elivVMnN81AnBnmI1GZuXAjn4s4avRKQ"
            >
              <img
                referrerPolicy="origin"
                src="https://trustseal.enamad.ir/logo.aspx?id=451010&Code=elivVMnN81AnBnmI1GZuXAjn4s4avRKQ"
                alt=""
                code="elivVMnN81AnBnmI1GZuXAjn4s4avRKQ"
              />
            </a>
          </div>
        </div>
