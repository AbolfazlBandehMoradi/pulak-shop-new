  ...
  return (
    <div className="flex flex-wrap bg-color-for-layer-sec rounded-2xl p-4">
      ...
      <div className="w-full sm:w-23/48 lg:w-12/48 mt-4 lg:mt-0  items-center gap-2 flex">
        ...
        <div className="flex h-full items-start flex-col justify-around">
          <h5 className="font-s-sbold text-base first-text-color">پشتیبانی 24 ساعته</h5>
          <p className="text-sm first-text-color-for-paragraph">کارشناسان ما پاسخگوی شما هستند</p>
        </div>
      </div>
      <div className="w-full sm:w-23/48 lg:w-12/48 mt-4 lg:mt-0  items-center gap-2 flex">
        <div className="relative">
        ...
        <div className="flex h-full items-start flex-col justify-around">
          <h5 className="font-s-sbold text-base first-text-color">تضمین کیفیت کالا</h5>
          <p className="text-sm first-text-color-for-paragraph">کالاهای چک شده و تایید شده</p>
        </div>
      </div>
      <div className="w-full sm:w-23/48 lg:w-12/48 mt-4 lg:mt-0  items-center gap-2 flex">
        <div className="relative">
        ...
        <div className="flex h-full items-start flex-col justify-around">
          <h5 className="font-s-sbold text-base first-text-color">امکان پرداخت آنلاین</h5>
          <p className="text-sm first-text-color-for-paragraph">با درگاه اینترنتی کاملا امن</p>
        </div>
      </div>
    </div>
  );
